...
- [ ] 1. dola テストをドメイン別サブディレクトリに再編する
- [ ] 1.1 (P) compile ドメイン: エントリポイント生成とファイル移動
...
- [ ] 1.2 (P) runtime ドメイン: エントリポイント生成とファイル移動
...
- [ ] 1.3 (P) trigger ドメイン: エントリポイント生成とファイル移動
...
- [ ] 1.4 (P) validation ドメイン: エントリポイント生成・ファイル移動・共通ヘルパー統合
...
- [ ] 1.5 (P) general ドメイン: エントリポイント生成とファイル移動
...
- [ ] 2. wintf テストをドメイン別サブディレクトリに再編する
- [ ] 2.1 (P) layout ドメイン: エントリポイント生成とファイル移動
...
- [ ] 2.2 (P) graphics ドメイン: エントリポイント生成とファイル移動
...
- [ ] 2.3 (P) visual ドメイン: エントリポイント生成・ファイル移動・共通ヘルパー統合
...
- [ ] 2.4 (P) widget ドメイン: エントリポイント生成とファイル移動
...
- [ ] 2.5 (P) window ドメイン: エントリポイント生成とファイル移動
...
- [ ] 2.6 (P) ecs ドメイン: エントリポイント生成とファイル移動
...
- [ ] 2.7 wintf テスト整理の動作確認
  - `cargo test -p wintf` を実行し全テストがパスすることを確認する
  - _Requirements: 2.2_

---

- [ ] 3. テスト命名規約を structure.md に文書化する
...
- [ ] 4. wintf ecs/ プロダクションファイルを適切なサブモジュールに移動する
- [ ] 4.1 monitor.rs と window_system.rs を window/ サブモジュールに移動する
