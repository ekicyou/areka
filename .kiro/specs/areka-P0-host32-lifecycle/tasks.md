...
- [ ] 1.2 統一報告語彙・shutdown 失敗語彙の型骨格と定数を定義
...
- [ ] 2.2 死活監視の器（非ブロッキング・sticky・冪等後始末）を実装
...
- [ ] 2.3 死活・request 失敗の統一報告の生成とログ規律の実装
...
- [ ] 2.4 正規の正常終了要求（ホスト側）と shutdown 失敗語彙を実装
