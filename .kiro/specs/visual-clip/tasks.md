...
- [x] 1. ClipShape 型定義と Visual への統合
- [x] 1.1 ClipShape enum を定義する
...
- [x] 1.2 Visual コンポーネントに clip フィールドを追加する
...
- [x] 2. COM API ラッパー拡張
- [x] 2.1 (P) DCompositionDeviceExt に create_rectangle_clip を実装する
...
- [x] 2.2 (P) DCompositionVisualExt に set_clip を実装する
...
- [x] 2.3 (P) D2D1FactoryExt に create_rounded_rectangle_geometry を実装する
...
- [x] 3. DComp モード — clip_sync_system 実装
- [x] 3.1 clip_sync_system の基本構造を実装する
...
- [x] 3.2 ClipShape バリアント別の RectangleClip 設定を実装する
...
- [x] 3.3 clip_sync_system をスケジュールに統合する
...
- [x] 4. ULW モード — render_subtree クリップ拡張
- [x] 4.1 ClipGuard RAII 構造を実装する
...
- [x] 4.2 Rectangle クリップ実装（PushAxisAlignedClip）
...
- [x] 4.3 RoundedRectangle クリップ実装（PushLayer + Geometry）
...
- [x] 4.4 RoundedRectangleIndividual クリップ実装（PathGeometry）
...
- [x] 4.5 render_subtree クエリに Arrangement 追加とクリップフロー統合
...
- [x] 6. テスト実装
- [x]* 6.1 Unit tests（ClipShape と Visual）
...
- [x]* 6.2 Integration tests（clip_sync_system と render_subtree）
