...
- [x] 1. Foundation: 既存実装の撤去と DComp 前提の最小起動骨組み
...
- [x] 3. Core: DComp 透過窓（NOREDIRECTIONBITMAP・視覚透過）
...
- [x] 5. Integration: 起動初期状態とライフサイクル
