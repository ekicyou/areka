...
- [x] 4.5 (P) ユニットテスト: CueQueue 基本操作の検証
...
- [x] 4.7 (P) ユニットテスト: EntityRegistry の検証
...
- [x] 4.8 統合テスト: CueSheet 配送 E2E の検証
...
- [x] 4.9 統合テスト: CueSheetTracker ライフサイクルの検証
