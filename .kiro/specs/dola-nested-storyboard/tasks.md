...
- [x] 1.1 (P) StoryboardEntry にトリガーフィールドを追加
...
- [x] 1.2 (P) CompiledTrigger 構造体を定義
...
- [x] 1.5 (P) DolaError にトリガー関連エラーを追加
...
- [x] 3.1 compile_storyboard() でトリガーエントリを処理
...
- [x] 4.3 update() の返却値を UpdateResult に変更
...
- [x] 5.1 (P) トリガーエントリの serde 往復テストを追加
...
- [x] 5.3 (P) CompiledTrigger の fire_time 計算テストを追加
...
| ---- | ----------- | --------------------------------- |
| 1.1  | ✅ Completed | 1.1, 1.2, 4.1, 4.2, 4.3, 4.4, 4.5 |
| 1.2  | ✅ Completed | 1.4, 3.3, 4.3                     |
| 1.3  | ✅ Completed | 2.2, 2.5                          |
| 1.4  | ✅ Completed | 5.1, 5.2                          |
| 1.5  | ✅ Completed | 3.1, 3.2, 3.5                     |
| 2.1  | ✅ Completed | 1.4                               |
| 2.2  | ✅ Completed | 3.1                               |
| 2.3  | ✅ Completed | 3.2                               |
| 2.4  | ✅ Completed | 1.3                               |
| 2.5  | ✅ Completed | 3.4                               |
| 2.6  | ✅ Completed | 1.5                               |
| 3.1  | ✅ Completed | 1.2, 1.4, 3.3, 4.4                |
| 4.1  | ✅ Completed | 2.1, 5.1, 5.2                     |
| 4.2  | ✅ Completed | 2.1, 2.2, 2.3, 5.4                |
| 4.3  | ✅ Completed | 2.5                               |
| 4.4  | ✅ Completed | 5.1, 5.2                          |
| 4.5  | ✅ Completed | 2.4, 5.3                          |
| 5.1  | ✅ Completed | 4.1, 4.2, 4.3                     |
| 5.2  | ✅ Completed | 1.3, 1.5, 3.1, 3.2, 3.4           |
| 5.3  | ✅ Completed | 1.2, 1.4, 3.3                     |
| 5.4  | ✅ Completed | 2.1, 2.2, 2.5                     |
| 5.5  | ✅ Completed | 5.1, 5.2                          |
| 5.6  | ✅ Completed | 2.3, 2.4, 5.3, 5.4                |
