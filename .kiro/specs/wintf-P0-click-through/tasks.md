...
- [x] 1. WndProc Layer クリックスルー機能実装
- [x] 1.1 (P) ヒットテスト結果に基づく分岐処理を実装
...
- [x] 2. ECS Layer 透明領域判定機能実装 (P)
- [x] 2.1 (P) Opacity/Brushes α値判定ロジックを実装
...
- [x] 4. 自動テスト実装
- [x] 4.1 WndProc Layer 分岐ロジックのテストを実装
...
- [x] 4.2 ECS Layer α値判定ロジックのテストを実装
