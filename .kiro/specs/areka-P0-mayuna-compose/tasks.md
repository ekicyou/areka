...
- [ ] 1. parsers 名前解決基盤
- [ ] 1.1 (P) bindgroup 名前宣言のデータ型とアクセサを追加する
...
- [ ] 1.2 descript の bindgroup 名前宣言をマウントモデルへ取り込む
...
- [ ] 3.1 (P) bind 名前解決とスコープ写像の純関数を実装する
...
- [ ] 4. (P) emo-present 再合成回帰（test-only）
...
- [ ] 7.1 起動時の資産構築へ bind 名前解決情報を組み込む
