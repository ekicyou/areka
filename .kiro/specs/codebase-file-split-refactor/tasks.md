...
- [ ] 1. wintf graphics モジュール分割

- [ ] 1.1 graphics/systems.rs を6サブモジュールに分割
...
- [ ] 1.2 compositor_systems.rs を2ファイルに分割
...
- [ ] 2. (P) wintf ecs/window.rs をディレクトリモジュールに分割
...
- [ ] 3. (P) wintf ecs/pointer/mod.rs を3サブファイルに分割
...
- [ ] 4. (P) wintf com/d2d/command.rs を2ファイルに分割
...
- [ ] 5. wintf ecs/layout 分割

- [ ] 5.1 (P) layout/systems.rs を4サブモジュールに分割
...
- [ ] 5.2 (P) hit_test.rs のインラインテストを外部ファイルに移動
...
- [ ] 5.3 (P) hit_region.rs のインラインテストを外部ファイルに移動
...
- [ ] 6. (P) wintf ecs/world.rs をディレクトリモジュールに分割
...
- [ ] 7. wintf ecs/window_proc 分割

- [ ] 7.1 mouse_button.rs をクリック系とダブルクリック・ホイール系に分割
...
- [ ] 7.2 window_proc/window_pos.rs からDPIヘルパーを分離
...
- [ ] 8. (P) wintf typewriter_systems.rs をレイアウトと描画に分割
...
- [ ] 9. (P) dola compile.rs をディレクトリモジュールに分割
...
- [ ] 10. (P) dola validate.rs をtrait定義とルール実装に分割
...
- [ ] 12.1 (P) examples/taffy_flex_demo.rs をディレクトリ例に変換
