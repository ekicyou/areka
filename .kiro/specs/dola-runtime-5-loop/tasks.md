...
- [ ] 1. データ構造とエラー定義の拡張
- [ ] 1.1 (P) RuntimeError にループ関連エラーバリアントを追加
...
- [ ] 1.2 (P) StoryboardInstance にループ状態管理フィールドを追加
...
- [ ] 2. LoopController モジュール実装
- [ ] 2.1 LoopAction enum と周回判定・進行関数を実装
...
- [ ] 3. facade.rs にループ再生統合
- [ ] 3.1 start() でループバリデーションと end_time 算出を実装
...
- [ ] 4. (P) timeline_manager.rs のループ対応
- [ ] 4.1 (P) calculate_effective_time() を loop_start_time ベースに変更
