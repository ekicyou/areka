...
- [x] 2. 競合検出の中核ロジック実装
- [x] 2.1 (P) detect_overlaps() による時間重複検出
...
- [x] 2.2 (P) resolve_conflicts() のディスパッチ骨組み実装
...
- [x] 3.2 (P) Conclude 戦略: 現在セグメントの最終値にジャンプ
...
- [x] 3.4 (P) Compress 戦略: ストーリーボード全体の最終値にジャンプ
...
- [x] 4. Never 戦略とデフォルト設定
- [x] 4.1 Never 戦略: 競合時に start() をエラー終了
...
- [x] 5. 既存モジュールの修正
- [x] 5.1 (P) InstanceManager::transition() の自動削除統一
...
- [x] 5.2 facade::start() への Tier 3 Hook 統合
