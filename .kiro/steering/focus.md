...
- 棚卸しの基準実数（2026-07-05 更新・delta）: 完了 **113**（+`areka-P0-host32-request`）／**active = 0**／**brief-only = 6**。**M1 M-boot 進捗 約 8/19**（②parsers 全完了・①shiori: pilot✅/ipc✅/shiori-load✅/**request✅**・lifecycle 残）。host32-request 完了で①shiori トラックは lifecycle 1 本を残すのみ。正本 roadmap.md ポートフォリオ節
