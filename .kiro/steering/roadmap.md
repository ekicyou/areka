...
|---|---|---|---|
| 基盤 | 裁定の登記＋前提の決定論テスト＝f32 供給面寸の許容を固定（配管は 2026-08-14 却下） | `scale-exact-rational` | **W6.5** |
