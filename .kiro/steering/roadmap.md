...
- 完了 spec = **157**（`.kiro/specs/completed/` の**直下エントリ数**＝ディレクトリ 156 ＋ 単体ファイル `graphics-rendering-stability.md` 1・2026-08-14 実測一致確認済み）。**ディレクトリ数を採ると 1 ずれる**ので計数時は直下エントリで数えること。
