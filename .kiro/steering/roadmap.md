...
- `completed/` = 105（歴史・M1 が立つ土台の記録。2026-07-01 `pilot-clickthrough-alpha-toggle`・`pilot-shiori-host-32` を go 済みでアーカイブ／2026-07-02 `areka-P0-host32-ipc`・`wintf-clickthrough-alpha-toggle` を実装完了でアーカイブ）。
