...
## spec 台帳（**表は 47 行**。うち **brief 済み 42 本**＝2026-09-13 の 30 ＋ 09-18 起票 8 ＋ 09-19 起票 3 ＋ 09-20 起票 1（#47 `balloon-break`）、**#38〜#42 の 5 行は brief を持たない「登記だけの行」**＝下の節を見よ。**状態列の実数え（2026-09-20・#47 の完了で 完了 +1／α 後 −1）＝完了 14・α 7・α 後 25・保留 1 ＝ 47**。着手は brief 持ちが `/kiro-start <名>`・登記だけの行は `/kiro-discovery` から）
