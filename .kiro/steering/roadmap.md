...
## spec 台帳（**表は 45 行**。うち **brief 済み 40 本**＝2026-09-13 の 30 ＋ 09-18 起票 7 ＋ 09-19 起票 3、**#38〜#42 の 5 行は brief を持たない「登記だけの行」**＝下の節を見よ。**状態列の実数え（2026-09-19・`areka-P0-popup-menu-minimal` の `/kiro-complete` 時に数え直し）＝完了 12・α 7・α 後 25・保留 1 ＝ 45**。着手は brief 持ちが `/kiro-start <名>`・登記だけの行は `/kiro-discovery` から）
