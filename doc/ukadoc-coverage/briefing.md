...
| 文書 | 絶対パス | 行数 |
| --- | --- | ---: |
| 束の帰属の正本 | `C:/home/maz/git/areka/doc/ukadoc-coverage/linkage.md` | 4,899 |
| 段階と順位の正本（この文書） | `C:/home/maz/git/areka/doc/ukadoc-coverage/briefing.md` | 2,574 |
| 候補 spec とウェーブ案 | `C:/home/maz/git/areka/doc/ukadoc-coverage/roadmap-draft.md` | 1,167 |
...
**合わせて 30 件**である。内訳は、段階の割り当て 10 件（2-5）・台帳の読み方 2 件（6-3）・本
spec の作業から出た 18 件（下の表）である。
...
| 18 | 候補 spec 名 **63 個**をいつ実在させるか | いまはどれも案で、この綴りの spec は 1 つも無い |
...
6 束の構成 id は合わせて **324 件**で、うち **85 件**を進行中の spec が、**29 件**を封じた
spec が宛先に持つ。**この 6 束に掛かる同順位の組は 0 組・段階の裁定候補は 0 束である**（数え
