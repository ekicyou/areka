...
- いま置き場にあるが表に無いもの **0 本**（2026-09-13 の時点では `areka-P0-nar-install` と
  `areka-P0-shell-implicit-surface` の 2 本がこちら側に居た。2026-09-19 に前者の行が、
  2026-09-20 に後者の行が表へ増えたので、いまは 0 本である。下の「2026-09-19 の追加」と
  「2026-09-20 の追加」を見よ）
