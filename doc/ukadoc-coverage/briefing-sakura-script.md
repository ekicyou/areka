...
> **注記（2026-09-13 時点）**: 本節の 259 件は調査時点（2026-09-06）の数である。その後 `areka-P0-text-decoration-canon` が `\f` の装飾タグを実装したため、**2026-09-13 時点の台帳は実装済み 32／語彙のみ 38／未対応 248** である。本節の分類と本文は調査時点の記録として残す。
